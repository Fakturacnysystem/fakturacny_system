...
export AUTONOMOUS_TRADE_COOLDOWN_S="${AUTONOMOUS_TRADE_COOLDOWN_S:-5}"
export AUTONOMOUS_MIN_SECONDS_BETWEEN_ORDERS="${AUTONOMOUS_MIN_SECONDS_BETWEEN_ORDERS:-5}"
export ORDER_SUBMISSION_INTERVAL_SECONDS="${ORDER_SUBMISSION_INTERVAL_SECONDS:-5}"
