        ...
        loaded.append(
            {
                ...
                "performance_targets": settings.config_manifest().get("performance_targets", {}),
                "capital_envelope": settings.config_manifest().get("capital_envelope", {}),
                "market_universe": settings.config_manifest().get("market_universe", {}),
            }
        )
