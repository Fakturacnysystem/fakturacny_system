...
class LiveKrakenSpotService:
    ...
    def execute_intent(self, intent) -> LiveExecutionResult:
        ...
        try:
            ...
            if ask <= 0:
                return LiveExecutionResult(status="blocked", reason="invalid_book_ask")
        ...
        try:
            ...
            return self._reject_guard(exc, {"pair": pair, "volume": vol, "price": price})
